...
import {NewsWrapper, NewsTitle, NewsDescription, WrapperRightContent, NewsFooter, TimeBlock, CommentBlock} from "./news_blok.style";
            ...
            <WrapperRightContent>
                ...
                <NewsFooter>
                    <TimeBlock>{dates}</TimeBlock>
                        <img src="https://cdn0.iconfinder.com/data/icons/free-daily-icon-set/512/Comments-512.png" alt=""/>
